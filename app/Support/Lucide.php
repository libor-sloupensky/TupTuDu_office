...
/**
 * Ikony Lucide (ISC licence) jako vlozene SVG.
 *
 * Projekt nema build step, takze se ikony nevkladaji pres JS knihovnu ani z CDN
 * - je tu jen obsah <svg> pro kazdou ikonu a Blade komponenta `<x-ikona>` ho
 * obali. Zadny externi pozadavek, zadna zavislost navic.
 *
 * Novou ikonu pridas stazenim z oficialniho balicku, ne rucnim kreslenim:
 *   curl -sSL https://unpkg.com/lucide-static@1.34.0/icons/NAZEV.svg
 * a vnitrek <svg> vlozis sem. Rucne psane cesty se rozchazeji s designem sady.
 *
 * Prehled ikon: https://lucide.dev/icons
 */
class Lucide
{
    /** Verze sady, ze ktere jsou ikony prevzate */
    public const VERZE = '1.34.0';
    ...
    /** Vnitrek <svg> pro danou ikonu, nebo null kdyz ji nezname. */
